...
@RestController
@RequestMapping("/api/jazzure-kafka")
public class JazzureKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JazzureKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JazzureKafkaResource(KafkaProperties kafkaProperties) {
